...
package com.slife.chris.studentlife.view;
...
import com.slife.chris.studentlife.utilities.QiscusAudioRecorder;
...
public class QiscusAudioRecorderView extends LinearLayout {
    ...
    private void initLayout() {
        ...
        buttonCancelRecord.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
