...
final class Manager extends Handler {
  ...
  /**
   * @return The currently used instance of the {@link com.de.keyboardsurfer.android.widget.crouton.Manager}.
   */
   ...
   *
   * @param crouton
   *     The {@link Crouton} added to a {@link android.view.ViewGroup} and should be
   *     removed.
   */
